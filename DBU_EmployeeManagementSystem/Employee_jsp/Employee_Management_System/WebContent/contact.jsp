		...
		<div class="card">
			<div class="card-body">
				...
				<form action="message" method="post">
					...
					<br> <label>Please Enter Message:</label> <input
						type="text" placeholder="Message" style="height: 10rem;" class="form-control"
						name="message" required="required"><br> <input type="submit"
						class='btn btn-danger' value="Send" style="background-color:green; border-color:green">
